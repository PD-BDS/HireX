...
JOB_DESCRIPTION_CREW_MODEL = "gpt-4.1"
JOB_DESCRIPTION_CREW_TEMPERATURE = 0.7

SCREENING_CREW_MODEL = "gpt-4.1"
SCREENING_CREW_TEMPERATURE = 0.6

QUERY_MANAGER_CREW_MODEL = "gpt-4.1"
QUERY_MANAGER_CREW_TEMPERATURE = 0.3

DISCUSSION_CREW_MODEL = "gpt-4.1"
DISCUSSION_CREW_TEMPERATURE = 0.8

RESUME_PARSING_CREW_MODEL = "gpt-4o"
